...
<Lede>Only when there's a charge that starts above a threshold. Here's how to tell, with real numbers.</Lede>
...
- Daily UPI limits. If your bank caps how much you can send by UPI in a day, splitting doesn't change the total.
